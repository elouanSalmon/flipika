            ...
            <div className="card flex-1 flex flex-col p-0 overflow-hidden relative">
                ...
                <div className="flex-1 p-8 overflow-y-auto flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-[var(--color-text-secondary)] max-w-md mb-8">
                        Je peux analyser vos campagnes, suggérer des mots-clés ou optimiser vos enchères en temps réel.
                    </p>

                    {/* Suggestions Chips */}
                    <div className="flex flex-wrap justify-center gap-3 max-w-lg">
                        {['Optimiser mes campagnes', 'Analyser le ROAS', 'Suggérer des mots-clés', 'Audit de performance'].map((suggestion) => (
                            <button
                                key={suggestion}
