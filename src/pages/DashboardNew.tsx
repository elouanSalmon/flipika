...
const DashboardNew = () => {
    ...
    if (authError && !isDemoMode) {
        return (
            <div className="flex flex-col items-center justify-center p-12 bg-white dark:bg-neutral-800 rounded-2xl border border-red-200 dark:border-red-900 shadow-sm">
