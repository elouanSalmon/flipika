                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <section className="mb-32">
                        <motion.div
                            ...
                            className="text-center mb-16"
                        >
                            <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight text-[var(--color-text-primary)]">{t(`${competitor.slug}:page.testimonialsTitle`)}</h2>
                            <p className="text-xl text-[var(--color-text-secondary)]">{t(`${competitor.slug}:page.testimonialsSubtitle`)}</p>
                        </motion.div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {['testimonial1', 'testimonial2', 'testimonial3'].map((testimonial, index) => (
                                ...
                                >
                                    ...
                                    <p className="text-[var(--color-text-secondary)] italic mb-6 leading-relaxed">"{t(`${competitor.slug}:testimonials.${testimonial}.quote`)}"</p>
                                    <div className="border-t border-[var(--color-border)] pt-6">
                                        <p className="font-bold text-[var(--color-text-primary)]">{t(`${competitor.slug}:testimonials.${testimonial}.author`)}</p>
                                        <p className="text-sm text-[var(--color-text-muted)]">{t(`${competitor.slug}:testimonials.${testimonial}.role`)}</p>
                                        <p className="text-sm text-[var(--color-primary)]">{t(`${competitor.slug}:testimonials.${testimonial}.company`)}</p>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
