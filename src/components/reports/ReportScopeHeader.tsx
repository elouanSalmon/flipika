...
const ReportScopeHeader: React.FC<ReportScopeHeaderProps> = ({
    ...
    return (
        <div
            className="bg-white dark:bg-black border-b border-neutral-200 dark:border-white/10 px-4 flex items-center justify-start text-sm shadow-sm z-30"
            style={{
                position: 'fixed',
        ...
        >
            <div className="flex items-center space-x-6 overflow-x-auto no-scrollbar max-w-fit h-full mr-6">
                {/* Dates */}
                <div
                    className="flex items-center text-neutral-600 dark:text-neutral-300 whitespace-nowrap min-w-fit cursor-pointer hover:bg-neutral-100 dark:hover:bg-white/5 px-2 py-1 rounded transition-colors"
                ...
                <div className="h-3 w-px bg-neutral-200 dark:bg-white/10 hidden sm:block"></div>
            ...
            <div className="h-3 w-px bg-neutral-200 dark:bg-white/10 hidden sm:block mr-6"></div>
