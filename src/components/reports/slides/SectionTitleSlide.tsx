...
const SectionTitleSlide: React.FC<SectionTitleSlideProps> = ({
    ...
    return (
        <div
            ...
            style={{
                backgroundColor: design?.colorScheme?.primary || '#1963d5', // Use primary color as background for impact
        ...
        >
            <h1
                ...
                style={{
                    fontFamily: design?.typography?.headingFontFamily || design?.typography?.fontFamily || 'DM Sans, sans-serif',
                }}
            >
                {title}
            </h1>
