    ...
    return (
        ...
        >
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-xl border-2 border-primary/20 dark:border-primary/30 bg-white/30 dark:bg-neutral-700/30 backdrop-blur-sm transition-all duration-300 shadow-lg shadow-primary/5">
