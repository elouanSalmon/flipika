...
const MigrationCTA: React.FC<MigrationCTAProps> = ({ competitor }) => {
    ...
    return (
        <div className="relative group mt-32">
            <div className="absolute inset-0 bg-primary/10 rounded-[3rem] blur-3xl group-hover:bg-primary/15 transition-all duration-700" />
            <div className="relative glass-card border border-white/20 dark:border-white/10 rounded-[3rem] p-12 md:p-20 text-center shadow-2xl overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary dark:text-primary-light text-sm font-bold mb-10 tracking-widest uppercase"
                    >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <button
                            ...
                            className="w-full sm:w-auto px-10 py-5 rounded-2xl bg-primary text-white font-black text-xl hover:bg-primary-dark transition-all transform hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(37,99,235,0.4)] flex items-center justify-center gap-3"
                        >
